...
public class PDFExporter {
    ...
    private static int addInstructions(PdfDocument document, int pageNumber) {
        ...
        y = drawWrappedText(canvas, paint, "https://www.opengd77.com/downloads/PC_CPS/Latest/OpenGD77CPSInstaller_R2025.03.23.01.exe", MARGIN, y, USABLE_WIDTH);
        paint.setTextSize(BODY_SIZE);  // Reset to normal size
        y += 5;
        
        paint.setColor(Color.BLACK);
        y = drawWrappedText(canvas, paint, "Alternative download (GitHub-hosted backup):", MARGIN, y, USABLE_WIDTH);
        y += 5;
        ...
        paint.setColor(Color.BLACK);
        y = drawWrappedText(canvas, paint, "Download the Windows installer from the official website or use the GitHub backup. For other platforms (macOS, Linux), visit opengd77.com.", MARGIN, y, USABLE_WIDTH);
        y += 25;
        ...
        paint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
        canvas.drawText("Power & Squelch Conversion:", MARGIN, y, paint);
        y += 16;
        
        paint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.NORMAL));
        y = drawWrappedText(canvas, paint, "• Power levels: App Low=P1, App High=P9. Import P1-P4=Low, P5-P9/+W-=High", MARGIN + 10, y, USABLE_WIDTH - 10);
        y = drawWrappedText(canvas, paint, "• Squelch (Analog only): App 0-9 converts to OpenGD77 Disabled/5%/15%/25%...85%", MARGIN + 10, y, USABLE_WIDTH - 10);
        y = drawWrappedText(canvas, paint, "• Digital channels always have Disabled squelch in OpenGD77", MARGIN + 10, y, USABLE_WIDTH - 10);
        y += 25;
        
        // Footer
        paint.setTextSize(SMALL_SIZE);
        paint.setColor(Color.GRAY);
        canvas.drawText("Generated by DMRModHooks v1.1 - LSPosed Module for Ulefone PriInterPhone", MARGIN, PAGE_HEIGHT - 30, paint);
